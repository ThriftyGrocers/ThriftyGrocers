...
const HomePage = () => {
  ...
  <div className="pt-24">
    <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
      {/*Left Col*/}
      {/*<div id="todoList">
  <input type="text" id="newTodoItem" placeholder="New Todo">
  ...
  <div>
    <p className="text-center p-3">
      Created By:{" "}
      <a href="https://www.linkedin.com/in/shaheer-arfat/">Shaheer Arfat</a>
    </p>
  </div>
  ...
  */}
      ...
      <div>
        <p className="text-center p-3">
          Created By: <a href="https://www.linkedin.com/in/shaheer-arfat/">Shaheer Arfat</a>
        </p>
      </div>
    </>
  );
